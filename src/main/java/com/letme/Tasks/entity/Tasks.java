...
public class Tasks {
    ...
    public Tasks(String name, Integer type_id, String desc, Date created_date, Date expire_date, Integer budget, String street_add, Integer city_id, Integer country_id, Integer zip, Integer status, boolean active) {
        this.name = name;
    ...
    public void setCity(Integer country_id) {
        this.country_id = country_id;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (country_id != null ? !country_id.equals(tasks.country_id) : tasks.country_id != null) return false;
